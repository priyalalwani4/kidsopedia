...
let vegetables = require('../Database/vegetableDb.json');
...
export default class VegetablesScreen extends React.Component {
  ...
  renderItem = ({ item: vegetables }) => {
    //console.log(alphabet);
    return <VegetableCard vegetables={vegetables} />;
  };
    ...
    if (!this.state.fontsLoaded) {
      ...
      return (
        <View style={styles.container}>
          ...
          <AppTitle />
          <View style={{ flex: 0.1 }}>
            <Text style={styles.nameText}>Learn Vegetables</Text>
          </View>
          <View style={{ flex: 0.8 }}>
